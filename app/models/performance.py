...
class SpacePerformanceAttributes(PerformanceAttributes):
    aim: float
    reading: float


class SpaceDifficultyAttributes(DifficultyAttributes):
    aim_difficulty: float
